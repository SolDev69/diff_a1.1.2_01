...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float renderPartialTick, boolean hasScreen, int width, int height) {
		...
		if(Keyboard.isKeyDown(Keyboard.KEY_F3)) {
			var8.drawStringWithShadow("Minecraft Alpha v1.1.2_01 (" + this.mc.debug + ")", 2, 2, 0xFFFFFF);
			var8.drawStringWithShadow(this.mc.debugInfoRenders(), 2, 12, 0xFFFFFF);
			var8.drawStringWithShadow(this.mc.getEntityDebug(), 2, 22, 0xFFFFFF);
			var8.drawStringWithShadow(this.mc.debugInfoEntities(), 2, 32, 0xFFFFFF);
			...
			var8.drawStringWithShadow("Minecraft Alpha v1.1.2_01", 2, 2, 0xFFFFFF);
		}
		...
		for(var15 = 0; var15 < this.chatMessageList.size() && var15 < var24; ++var15) {
			if(((ChatLine)this.chatMessageList.get(var15)).updateCounter < 200 || var26) {
				...
				if(var18 > 0) {
					...
					GL11.glEnable(GL11.GL_BLEND);
					var8.drawStringWithShadow(var21, var30, var20, 0xFFFFFF + (var18 << 24));
				}
			}
		}
