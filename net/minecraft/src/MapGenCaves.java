...
public class MapGenCaves extends MapGenBase {
	protected void generateLargeCaveNode(int var1, int var2, byte[] data, double var4, double var6, double var8) {
		this.generateCaveNode(var1, var2, data, var4, var6, var8, 1.0F + this.rand.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
	}

	protected void generateCaveNode(int x, int z, byte[] data, double var4, double var6, double var8, float var10, float var11, float var12, int var13, int var14, double var15) {
		double var17 = (double)(x * 16 + 8);
		double var19 = (double)(z * 16 + 8);
		float var21 = 0.0F;
		float var22 = 0.0F;
		...
		for(boolean var26 = var23.nextInt(6) == 0; var13 < var14; ++var13) {
			...
			if(!var52 && var13 == var25 && var10 > 1.0F) {
				this.generateCaveNode(x, z, data, var4, var6, var8, var23.nextFloat() * 0.5F + 0.5F, var11 - (float)Math.PI / 2F, var12 / 3.0F, var13, var14, 1.0D);
				this.generateCaveNode(x, z, data, var4, var6, var8, var23.nextFloat() * 0.5F + 0.5F, var11 + (float)Math.PI / 2F, var12 / 3.0F, var13, var14, 1.0D);
				return;
			}
			...
			if(var52 || var23.nextInt(4) != 0) {
				...
				if(var4 >= var17 - 16.0D - var27 * 2.0D && var8 >= var19 - 16.0D - var27 * 2.0D && var4 <= var17 + 16.0D + var27 * 2.0D && var8 <= var19 + 16.0D + var27 * 2.0D) {
					int var53 = MathHelper.floor_double(var4 - var27) - x * 16 - 1;
					int var34 = MathHelper.floor_double(var4 + var27) - x * 16 + 1;
					int var54 = MathHelper.floor_double(var6 - var29) - 1;
					int var36 = MathHelper.floor_double(var6 + var29) + 1;
					int var55 = MathHelper.floor_double(var8 - var27) - z * 16 - 1;
					int var38 = MathHelper.floor_double(var8 + var27) - z * 16 + 1;
					if(var53 < 0) {
						var53 = 0;
					}
						...
						for(int var41 = var55; !var56 && var41 < var38; ++var41) {
							for(int var42 = var36 + 1; !var56 && var42 >= var54 - 1; --var42) {
								...
								if(var42 >= 0 && var42 < 128) {
									if(data[var43] == Block.waterMoving.blockID || data[var43] == Block.waterStill.blockID) {
										var56 = true;
									}
					...
					if(!var56) {
						for(var40 = var53; var40 < var34; ++var40) {
							double var57 = ((double)(var40 + x * 16) + 0.5D - var4) / var27;

							for(var43 = var55; var43 < var38; ++var43) {
								double var44 = ((double)(var43 + z * 16) + 0.5D - var8) / var27;
								...
								for(int var48 = var36 - 1; var48 >= var54; --var48) {
									...
									if(var49 > -0.7D && var57 * var57 + var49 * var49 + var44 * var44 < 1.0D) {
										...
										if(var51 == Block.stone.blockID || var51 == Block.dirt.blockID || var51 == Block.grass.blockID) {
											if(var48 < 10) {
												data[var46] = (byte)Block.lavaMoving.blockID;
											} else {
												data[var46] = 0;
												if(var47 && data[var46 - 1] == Block.dirt.blockID) {
													data[var46 - 1] = (byte)Block.grass.blockID;
												}
											}
										}
									}
	...
	protected void recursiveGenerate(World world, int var2, int var3, int var4, int var5, byte[] data) {
		...
		for(int var8 = 0; var8 < var7; ++var8) {
			...
			if(this.rand.nextInt(4) == 0) {
				this.generateLargeCaveNode(var4, var5, data, var9, var11, var13);
			...
			for(int var16 = 0; var16 < var15; ++var16) {
				...
				this.generateCaveNode(var4, var5, data, var9, var11, var13, var19, var17, var18, 0, 0, 1.0D);
			}
		}
