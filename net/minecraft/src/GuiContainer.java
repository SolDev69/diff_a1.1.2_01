...
public abstract class GuiContainer extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float renderPartialTick) {
		...
		for(int var6 = 0; var6 < this.inventorySlots.size(); ++var6) {
			...
			if(var7.getIsMouseOverSlot(mouseX, mouseY)) {
		...
		if(var10.draggedItemStack != null) {
			...
			itemRenderer.renderItemIntoGUI(this.fontRenderer, this.mc.renderEngine, var10.draggedItemStack, mouseX - var4 - 8, mouseY - var5 - 8);
			itemRenderer.renderItemOverlayIntoGUI(this.fontRenderer, this.mc.renderEngine, var10.draggedItemStack, mouseX - var4 - 8, mouseY - var5 - 8);
		}
