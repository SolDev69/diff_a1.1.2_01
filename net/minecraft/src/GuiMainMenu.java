...
public class GuiMainMenu extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float renderPartialTick) {
		...
		this.drawString(this.fontRenderer, var6, this.width - this.fontRenderer.getStringWidth(var6) - 2, this.height - 10, 0xFFFFFF);
			...
			for(int var6 = 0; var6 < this.logoBlockLayers.length; ++var6) {
				for(int var7 = 0; var7 < this.logoBlockLayers[var6].length(); ++var7) {
					...
					if(var8 != 32) {
						...
						float var10 = (float)(var9.prevHeight + (var9.height - var9.prevHeight) * (double)renderPartialTick);
						float var11 = 1.0F;
						float var12 = 1.0F;
						float var13 = 0.0F;
						if(var4 == 0) {
