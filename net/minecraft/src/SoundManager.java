		...
		if(loaded && this.options.soundVolume != 0.0F) {
			...
			if(sound != null) {
				...
				if(var8 != null && volume > 0.0F) {
					...
					float var9 = 16.0F;
					sndSystem.newStreamingSource(true, var7, var8.soundUrl, var8.soundName, false, posX, posY, posZ, 2, var9 * 4.0F);
	...
	public void playSound(String sound, float posX, float posY, float posZ, float volume, float pitch) {
		if(loaded && this.options.soundVolume != 0.0F) {
			...
			if(var7 != null && volume > 0.0F) {
				...
				sndSystem.newSource(volume > 1.0F, var8, var7.soundUrl, var7.soundName, false, posX, posY, posZ, 2, var9);
